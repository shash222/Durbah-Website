        ...
        return (
            <div className="container"> 
                ...
                <div className="countdownContainer" id="homeCountdownContainer">
                    ...
                    <Countdown datePassedMessage={["CLASS IS NOW ", <span key="liveTextSpan" className="liveText">IN SESSION</span>]} endDate={new Date(seminarData.seminarDate + " " + seminarData.seminarTime)}/>
                </div>
            </div>
        );
    }
